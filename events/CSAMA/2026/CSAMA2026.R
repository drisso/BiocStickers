...
hex <- ggplot() +
    ...
    geom_url(url = "CSAMA2026", x = 0.23, y = 1.25,
    ...
    geom_url(url = "www.bioconductor.org", size = 7, color = "#ffffff",
             x = 0.95, y = 0.11) +
    theme_sticker()
ggsave("CSAMA2026.png", plot = hex, width = 43.9,
       height = 50.8, units = "mm", bg = "transparent", dpi = 300,
...
hex <- ggplot() +
    ...
    hex_segment2(size = 0, fill = col_border,
                 from_radius = 0.94, to_radius = 1,
                 from_angle = 270, to_angle = 330) +
    geom_url(url = "CSAMA2026", x = 0.24, y = 1.31,
             family = "Aller", size = 40.0, color = col_border) +
    geom_url(url = "www.bioconductor.org", size = 18.0, color = "#000000",
             x = 1.001, y = 0.127) +
    geom_url(url = "www.bioconductor.org", size = 18, color = "#ffffff",
             x = 1, y = 0.13) +
    theme_sticker()
ggsave("CSAMA2026-tshirt.png", plot = hex, width = 12.098,
       height = 14, units = "cm", bg = "transparent", dpi = 300,
       type = "cairo-png", antialias = "subpixel")
...
hex <- ggplot() +
    ...
    geom_url(url = "www.bioconductor.org", size = 7, color = "#ffffff",
             x = 0.95, y = 0.11) +
    theme_sticker()
ggsave("CSAMA2026-a.png", plot = hex, width = 43.9,
       height = 50.8, units = "mm", bg = "transparent", dpi = 300,
       type = "cairo-png", antialias = "subpixel")
...
hex <- ggplot() +
    ...
    geom_url(url = "www.bioconductor.org", size = 7, color = "#ffffff",
             x = 0.95, y = 0.11) +
    theme_sticker()
ggsave("CSAMA2026-b.png", plot = hex, width = 43.9,
       height = 50.8, units = "mm", bg = "transparent", dpi = 300,
       type = "cairo-png", antialias = "subpixel")
